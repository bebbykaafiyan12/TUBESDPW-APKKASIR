...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body px-4 py-4-5" style="background-color: rgb(192, 230, 230)">
                    <div class="d-flex justify-content-start">
                        <div class="stats-icon green mb-2">
                            <i class="bi bi-check-square-fill"></i>
                        </div>
                        <div class="ms-3">
                            <h6 class="text-muted font-semibold">Orderan Berhasil</h6>
                            <h6 class="font-extrabold mb-0">55.000</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body px-4 py-4-5" style="background-color: rgb(136, 241, 241)">
                    <div class="d-flex justify-content-start">
                        ...
                        <div class="ms-3">
                            ...
                            <h6 class="font-extrabold mb-0">35.000</h6>
                        </div>
                    </div>
                </div>
            </div>
